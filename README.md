# InTxGNN - India: Drug Repurposing

> 本專案由 **藥提醒科技有限公司**（[yao.care](https://www.yao.care)）開發與維運。
> InTxGNN 站台：<https://intxgnn.yao.care/>｜產品總覽：<https://www.yao.care/medical/txgnn/>

[![Website](https://img.shields.io/badge/Website-intxgnn.yao.care-blue)](https://intxgnn.yao.care)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

Drug repurposing predictions for India India Pharma-approved drugs using the TxGNN model.
...
| **DHI Data** | 35 |
| **DDSI Data** | 8,359 |
| **FHIR Resources** | 818 MK / 5,544 CUD |
...
| **L5** | 818 | Computational prediction only |
...
| Metric | Value |
|------|------|
| India Pharma Total Drugs | 246,068 |
| Mapped to DrugBank | 221,028 (89.8%) |
| Repurposing Candidates | 5,544 |

### Deep Learning Method

```bash
conda activate txgnn
PYTHONPATH=src python -m intxgnn.predict.txgnn_model
```

| Metric | Value |
|------|------|
| Total DL Predictions | 2,180,479 |
| Unique Drugs | 1,178 |
| Unique Indications | 17,041 |
...
flowchart TD
    ...
    subgraph B["Step 1: DrugBundle Collector"]
        B1["Drug-level: India Pharma, DDI, DrugBank"]
...
```mermaid
flowchart TD
    FDA["India Pharma Data"] --> proc["process_fda_data.py"]
    TxGNN["TxGNN Data"] --> prep["prepare_external_data.py"]

    proc --> json["in_fda_drugs.json"]
...
```bibtex
@software{intxgnn2026,
  author       = {Yao.Care},
  title        = {InTxGNN: Drug Repurposing Validation Reports for India India Pharma Drugs},
  year         = 2026,
  publisher    = {GitHub},
  url          = {https://github.com/yao-care/InTxGNN}
}
```
