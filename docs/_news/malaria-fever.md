---
layout: default
title: "malaria (malaria fever) News"
parent: Health News
nav_exclude: true
description: "Health news about malaria (malaria fever). 1 articles, 2 related drugs."
permalink: /news/malaria-fever/
---

# malaria (malaria fever) News

[← Back to News Overview]({{ '/news/' | relative_url }})

---

<p class="key-answer" data-question="What news is there about malaria (malaria fever)?">
<strong>malaria (malaria fever)</strong> currently has <strong>1 news articles</strong> and 2 related drugs.
</p>

<div class="key-takeaway">
This page brings together the latest health news about “malaria” and lists the drugs in the InTxGNN database whose predicted indications include this disease.
</div>
...
<ul>
<li><a href="{{ '/drugs/artemether/' | relative_url }}">Artemether</a></li>
<li><a href="{{ '/drugs/nadifloxacin/' | relative_url }}">Nadifloxacin</a></li>
</ul>
</div>
