...
Teriparatide currently has **no registered authorizations** in the local market (`total_licenses: 0`, `market_status: 未上市 / Not marketed`). No license records, product names, dosage forms, or approved indication text are available to summarize.
