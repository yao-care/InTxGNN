...
Tolvaptan is currently **not marketed in India** — this evidence pack contains zero registered licenses (`total_licenses: 0`, `market_status: 未上市`). There is no local approved-indication text to extract.
