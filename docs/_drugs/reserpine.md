...
Reserpine currently has **no active registrations in Taiwan** (market status: 未上市 / Not marketed; total licenses: 0). No approved product label or indication text is available for reference (Data Gap DG001 — TFDA label/warnings not yet retrieved).
