...
No CDSCO registration currently on record. According to the evidence pack, temozolomide has **0 licenses** in India (`market_status: Not marketed` / Not Marketed) — there is no product currently authorized for sale.
