...
Tenecteplase currently has **no registered licenses in India** (`total_licenses: 0`, `market_status: Not marketed`). No product registrations, brand names, or approved-indication text are available in this evidence pack.
