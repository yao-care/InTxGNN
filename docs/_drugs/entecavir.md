...
Entecavir is **not currently registered** in India based on the data in this Evidence Pack (`market_status: "Not marketed"`, `total_licenses: 0`). No license authorization records are available to display.
