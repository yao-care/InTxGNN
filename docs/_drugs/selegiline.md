...
Selegiline currently has **no marketing authorization** on record in the India regulatory dataset used for this evaluation (`market_status: 未上市`, 0 registrations). No product listing table is available.
