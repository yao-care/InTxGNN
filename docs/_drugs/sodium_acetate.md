...
Sodium acetate holds **no marketing authorizations** in the India registry (`total_licenses: 0`, `market_status: Not marketed / Not Marketed`). No license records are available to summarize.
