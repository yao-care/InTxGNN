...
Warfarin currently has **no registered market authorizations in India** in this evidence pack (`market_status: 未上市` / Not Marketed, `total_licenses: 0`). No product-level dosage form or indication text is available for review.
