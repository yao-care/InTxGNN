...
Idebenone currently holds **no marketing authorization in Taiwan** (market status: 未上市, 0 registered licenses). No product-level registration data is available.
