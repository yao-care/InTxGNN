...
No market authorization records found. Climbazole currently has no registered pharmaceutical license in India (`market_status`: Not marketed / Not Marketed; `total_licenses`: 0).
