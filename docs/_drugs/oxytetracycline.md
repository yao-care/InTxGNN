...
Oxytetracycline currently has **no marketing authorization on file in India** (`market_status: Not marketed`, 0 registrations, no license records available for extraction).
