...
Metoprolol is a selective beta-1 adrenergic blocker with established clinical use in hypertension, angina pectoris, and heart failure.
...
**Rationale:**
No clinical trials or published literature directly support Metoprolol for malignant hypertensive renal disease, placing this prediction at the lowest evidence level (L5). Current guidelines favor ACEi/ARB as the primary renoprotective strategy in this setting, limiting Metoprolol to a supporting role without dedicated trial data.
