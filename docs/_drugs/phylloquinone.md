...
Phylloquinone is **not currently marketed** in India per this evidence pack (`market_status: Not marketed`, `total_licenses: 0`). No license records are available to summarize.
