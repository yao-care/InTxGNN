...
Terlipressin is not currently marketed in India — the evidence pack shows a market status of "Not marketed" (Not Marketed) with 0 registered licenses. No authorization records are available for extraction.
